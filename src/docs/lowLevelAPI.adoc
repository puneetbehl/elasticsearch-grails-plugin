...
Please refer to the http://www.elasticsearch.org/guide/reference/java-api/[Elastic Search API] for more information on the methods and properties available on the client.
