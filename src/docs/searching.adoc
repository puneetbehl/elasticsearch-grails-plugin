...
If you're willing to retrieve only the number of hits for a peculiar query, you can use the `countHits()` method.
It will only return an `Integer` representing the total hits matching your query.
