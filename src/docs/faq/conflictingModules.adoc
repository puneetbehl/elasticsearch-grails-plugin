...
It seems like there are multiple versions of groovy in the classpath.
Looks similar to http://stackoverflow.com/questions/31099214/tomcat-conflicting-module-versions-module-groovy-all-is-loaded-in-version-2-3
