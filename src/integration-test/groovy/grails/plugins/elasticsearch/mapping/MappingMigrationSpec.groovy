...
//            setupMappings()
//            Set<String> indices = catalogMapping.findAll { it.isRoot() }.collect {
//                it.domainClass.fullName.toLowerCase()
//            } as Set<String>
//            String indexName = indices.first()
//
...
//            es.indexPointedBy(catalogMapping.queryingIndex) == indexName
//            es.indexPointedBy(catalogMapping.indexingIndex) == indexName
//
//    }
//
...
//
//        and:
//            'It is a versioned alias to an ' alias ' strategy compatible index'
//            es.aliasExists(catalogMapping.indexName)
