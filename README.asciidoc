== Elasticsearch Grails plugin image:https://travis-ci.org/cgoIT/elasticsearch-grails-plugin.svg?branch=master["Build Status", link="https://travis-ci.org/cgoIT/elasticsearch-grails-plugin"]
...
The plugin documentation can be found at https://cgoit.github.io/elasticsearch-grails-plugin/index.html

For latest stable version of plugin documentation, https://cgoit.github.io/elasticsearch-grails-plugin/latest/index.html[Click Here]
